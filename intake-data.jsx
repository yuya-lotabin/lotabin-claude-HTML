...
(function () {
  ...
  const PLANS = {
    brand: [
      ...
      { id: 'standard', popular: false, name: { en: 'Standard', ja: 'Standard' }, tier: { en: 'Monthly', ja: '月額' }, price: { en: '$997', ja: '$997' }, per: { en: '/ mo', ja: '/ 月' }, blurb: { en: '6 packs / month · planned waves', ja: '6パック/月・計画されたウェーブ' } },
      ...
      { id: 'ent',      popular: false, name: { en: 'Enterprise', ja: 'Enterprise' }, tier: { en: 'High capacity', ja: '大容量' }, price: { en: '$2,497+', ja: '$2,497〜' }, per: { en: '/ mo', ja: '/ 月' }, blurb: { en: '15 packs · custom cadence', ja: '15パック・カスタム制作ペース' } },
    ],
    agency: [
